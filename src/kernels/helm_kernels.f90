...
subroutine h3d_slp_c(src, ndt,targ, ndd,dpars,ndz,zk,ndi,ipars,val)
  implicit real *8 (a-h,o-z)
  complex *16 :: src(*),targ(ndt)
  real *8 :: dpars(ndd)
  real *8 over4pi
  integer ipars(ndi)
  complex *16 :: zk, val
  complex *16 :: ima,dx,dy,dz,r
...
subroutine h3d_dlp_c(srcinfo,ndt,targ,ndd,dpars,ndz,zk,ndi,ipars,val)
  implicit real *8 (a-h,o-z)
  complex *16 :: srcinfo(12), targ(ndt)
  real *8 :: dpars(ndd)
  integer ipars(ndi)
  complex *16 :: zk, val
  complex *16 :: dx,dy,dz,d,r

  complex *16 :: src(3), srcnorm(3)
  real *8 over4pi
  complex *16 :: ima
  data ima/(0.0d0,1.0d0)/
  data over4pi/0.07957747154594767d0/
...
subroutine h3d_sprime_c(srcinfo,ndt,targinfo,ndd, &
    dpars,ndz,zk,ndi,ipars,val)
  implicit real *8 (a-h,o-z)
  complex *16 :: srcinfo(*), targinfo(12)
  real *8 :: dpars(ndd)
  integer ipars(ndi)
  complex *16 :: zk, val,dx,dy,dz,d,r
...
subroutine h3d_comb_c(srcinfo, ndt,targ, ndd,dpars,ndz,zpars,ndi,ipars,val)
  implicit real *8 (a-h,o-z)
  complex *16 :: srcinfo(12), targ(ndt)
  real *8 :: dpars(ndd)
  integer ipars(ndi)
  ...
  complex *16 :: src(3), srcnorm(3), dx,dy,dz,r,d
  real *8 over4pi
  complex *16 :: ima
  data ima/(0.0d0,1.0d0)/
  data over4pi/0.07957747154594767d0/
...
subroutine h3d_qlp_c(srcinfo, ndt,targ,ndd, dpars,ndz,zk,ndi,ipars,val)
  implicit real *8 (a-h,o-z)
  complex *16 :: srcinfo(12), targ(ndt)
  real *8 :: dpars(ndd)
  integer ipars(ndi)
...
subroutine h3d_dprime_diff_c(srcinfo, ndt,targ, ndd,dpars,ndz, &
  zpars,ndi,ipars,val)
!
!  This subroutine returns D_{k1}' - D_{k2}'
!  
...
!
  ...
  complex *16 :: src(3), rns(3),rnt(3),rnsdot,rntdot,rnstdot 
  complex *16 :: ima,z1,z2,ztmp,zexp,sexp,ztmp2
  complex *16 :: dx,dy,dz,r,rinv,rinv3,rinv5
  real *8 :: over4pi
  data ima/(0.0d0,1.0d0)/
  data over4pi/0.07957747154594767d0/
  ...
  return
end subroutine h3d_dprime_diff_c
...
subroutine h3d_slp_diff_c(src, ndt,targ, ndd,dpars,ndz,&
  zpars,ndi,ipars,val)
!
!  This subroutine evaluates the kernel
!    a0 S_{k0} - a1 S_{k1}
...
subroutine h3d_dlp_diff_c(srcinfo,ndt,targ,ndd,dpars,ndz,& 
  zpars,ndi,ipars,val)
!
!  This subroutine evaluates the kernel
!    a0 D_{k0} - a_{1} D_{k1}
...
subroutine h3d_sprime_diff_c(srcinfo,ndt,targinfo,ndd,& 
  dpars,ndz,zpars,ndi,ipars,val)
!
!  This subroutine evaluates the kernel
!    a0 S_{k0}' - a1 S_{k1}'
!
...
!        zpars(4) = a1
  ...
  return
end subroutine h3d_sprime_diff_c
...
subroutine h3d_sgradx_c(srcinfo,ndt,targinfo,ndd,dpars,&
  ndz,zk,ndi,ipars,val)
  implicit real *8 (a-h,o-z)
  complex *16 :: srcinfo(*), targinfo(*)
  real *8 :: dpars(ndd)
  complex *16 val
  integer ipars(ndi)
  complex *16 :: zk,ima
  complex *16 :: dx,dy,dz,r
...
subroutine h3d_sgrady_c(srcinfo,ndt,targinfo,ndd,dpars,&
  ndz,zk,ndi,ipars,val)
  implicit real *8 (a-h,o-z)
  complex *16 :: srcinfo(*), targinfo(*)
  real *8 :: dpars(ndd)
...
subroutine h3d_sgradz_c(srcinfo,ndt,targinfo,ndd,&
  dpars,ndz,zk,ndi,ipars,val)
  implicit real *8 (a-h,o-z)
  complex *16 :: srcinfo(*), targinfo(*)
  real *8 :: dpars(ndd)
