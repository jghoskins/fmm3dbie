...
subroutine getgeominfo_c(npatches, patchpnt, par1, par2, par3, par4, &
    npols, uvs, umatr, srcvals, srccoefs)
  implicit real *8 (a-h,o-z)
  real *8 :: uvs(2,npols)
  complex *16 :: srcvals(12,*)
  real *8 :: umatr(npols,npols)
  complex *16 :: srccoefs(9,*)
  complex *16 ds
  external patchpnt
  ...
  do ipatch=1,npatches
    do i=1,npols
      ...
      call cross_prod3d_c(srcvals(4,ipt),srcvals(7,ipt),srcvals(10,ipt))
